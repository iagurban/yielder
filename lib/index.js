(function(){
  ...
  create = function(options){
    var yieldables, strict, isPromise, toPromise, mainPromisificationator;
    ...
    toPromise = (function(){
      var object, iterable, generator, generatorFunction, async, promise, unknown;
      object = function(obj){
      ...
      generator = function(obj){
        return new Promise(function(resolve, reject){
          ...
          onFulfilled = function(method, res){
            ...
            try {
              ref$ = obj[method](res), done = ref$.done, value = ref$.value;
            } catch (e$) {
              e = e$;
              return reject(e);
            }
      ...
      generatorFunction = function(obj){
      ...
      function(o){
        switch (typeof o) {
        case 'function':
          return o instanceof GeneratorFunction && generatorFunction || async;
        case 'object':
          return (function(){
            switch (false) {
            case !isPromise(o):
    ...
    return mainPromisificationator = function(yieldable){
      var ref$;
      return (ref$ = toPromise(yieldable)) != null
        ? ref$
        : new Promise(function(){
          arguments[0](yieldable);
        });
    };
  };
